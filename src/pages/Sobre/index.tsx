    ...
    return (
        <section>
            ...
            <div className={styles.sobreNos}>
                <img src={casa} alt="Casa do Código" />
                <div className={styles.sobreNos__texto}>
                    <p>
                        Nós da Casa do Código oferecemos a vocês, nossos queridos clientes, a Massa Italiana Caseira mais saborosa e sofisticada de São Paulo! Prezamos pelos ingredientes tradicionais da culinária Italiana, frescos e de excelente qualidade para que sua experiência seja ainda mais intensa!
                    </p>
                    <p>
